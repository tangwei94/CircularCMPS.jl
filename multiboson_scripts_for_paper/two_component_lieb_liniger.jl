...
res1 = ground_state(Hm, ψ1; gradtol=1e-9, maxiter=5000, preconditioner_type=3);
...
res2 = ground_state(Hm, ψ2; gradtol=1e-9, maxiter=5000, preconditioner_type=3);
...
res3 = ground_state(Hm, ψ3; gradtol=1e-9, maxiter=5000, preconditioner_type=3);
...
res4 = ground_state(Hm, ψ4; gradtol=1e-9, maxiter=5000, preconditioner_type=3);
