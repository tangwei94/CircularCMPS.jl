...
res_d1 = ground_state(Hm, ϕ1; gradtol=1e-3*c, maxiter=1000, do_preconditioning=false);
ψ1 = left_canonical(MultiBosonCMPSData_MDMinv(res_d1[1]))
res1 = ground_state(Hm, ψ1; gradtol=1e-6*c, maxiter=5000, preconditioner_type=3);
...
res_d2 = ground_state(Hm, ϕ2; gradtol=1e-3*c, maxiter=1000, do_preconditioning=false);
...
res_d3 = ground_state(Hm, ϕ3; gradtol=1e-3*c, maxiter=1000, do_preconditioning=false);
...
#res_d4 = ground_state(Hm, ϕ4; gradtol=1e-3*c, maxiter=1000, do_preconditioning=false);
