...
res_d1 = ground_state(Hm, ϕ1; gradtol=1e-9, maxiter=1000, do_preconditioning=false);
...
res_d2 = ground_state(Hm, ϕ2; gradtol=1e-9, maxiter=1000, do_preconditioning=false);
...
res_d3 = ground_state(Hm, ϕ3; gradtol=1e-9, maxiter=1000, do_preconditioning=false);
...
res_d4 = ground_state(Hm, ϕ4; gradtol=1e-9, maxiter=2500, do_preconditioning=false);
